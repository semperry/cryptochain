...
describe("Transaction", () => {
	...
	beforeEach(() => {
		...
		amount = 50;
		transaction = new Tranaction({ senderWallet, recipient, amount });
	});
	it("has an `id`", () => {
	...
	describe("validTransaction()", () => {
		...
		describe("when the transaction is valid", () => {
			it("returns true", () => {
				expect(Tranaction.validTransaction(transaction)).toBe(true);
			});
		});
		...
		describe("when the transaction is invalid", () => {
			describe("and a transaction outputMap is invalid", () => {
				it("returns false and logs an error", () => {
					...
					expect(Tranaction.validTransaction(transaction)).toBe(false);
